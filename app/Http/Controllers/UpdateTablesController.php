...
class UpdateTablesController extends Controller
{
    public function allMaterials(Request $request)
    {
        ...
        $allBeforeMaterial = BeforeMaterialModel::orderBy('created_at', 'desc')->paginate(10, ['*'], 'before-material-page');
        $allProcess = ProcessModel::orderBy('created_at', 'desc')->paginate(10,['*'],'process-page');
