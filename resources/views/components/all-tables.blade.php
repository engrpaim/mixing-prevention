...
<div class="relative flex flex-col items-center">
    <div class="flex flex-row self-start mt-5 ">
        <h1 class="font-bold">MANAGE INFORMATION</h1>
    </div>
    <div class="flex self-start m-1 text-base max-sm:flex-col">
    ...
    <div class="flex flex-row mx-0 max-md:flex-col ">
    ...
    $forms = [
        ...
        [
            ...
            'action' => 'finish-data',
            'show' => 'FINISH:',
            'placeholder' => 'add after finish here',
    ...
    @endphp
    <div class="absolute flex self-start mt-72 max-sm:flex-col">
        <div class="flex flex-row">
    ...
    <div class="flex max-sm:relative md:absolute mt-80 sm:flex-row updateTables max-md:flex-col max-md:items-center minw-w-fit ">
        ...
        <x-table title="FINISH" :array="$allAfterMaterial" column="finish"  compare="Finish"/>
        </div>
    </div>
