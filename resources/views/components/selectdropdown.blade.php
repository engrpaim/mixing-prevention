<div class="flex flex-row pr-24 mx-2 min-h-fit min-w-fit ">
    ...
    <div class="flex flex-row">
        <select name="process" id="process" placeholder="hello"  class="p-3 ml-2 rounded-lg shadow-lg max-h-fit min-w-fit outline outline-1 outline-gray-300 hover:bg-blue-100 hover:outline-blue-500 hover:outline-2" name="model_name" id="model_name" >
    ...
    @if ($show == 'YES')
        <div class="flex flex-row ">
            <div  class="mb-1 ml-5 shadow-xl bg-slate-50 outline outline-1 outline-black-50 w-72 h-80 rounded-xl min-w-fit ">
